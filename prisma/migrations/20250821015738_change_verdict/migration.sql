/*
  ...
  - The values [RTE] on the enum `SubmissionVerdict` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."SubmissionVerdict_new" AS ENUM ('RN', 'AC', 'WA', 'AB', 'QU', 'IR', 'CE', 'RE', 'OLE', 'TLE', 'MLE', 'ISE', 'SK');
